...
# Ultra-detailed SQL generation prompt
SQL_PROMPT_TEMPLATE = """
You are a world-class SQL expert converting user questions into correct, optimized SQL for a SQLite database.
...
9. Keep SQL short, readable, and valid for SQLite.
